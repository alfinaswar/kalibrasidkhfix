...
<thead>
  <tr>
    <th colspan="3" style="text-align: left;">Pekanbaru, {{date('d F Y', strtotime($data->Tanggal));}}</th>
  </tr></thead>
<tbody>
  <tr>
    ...
    <table id="tabelalat">
        ...
        function terbilang($nilai)
        {
            ...
            <tr>
                ...
                <td style="text-align: right; font-weight: bold;">{{ "Rp. " . number_format($data->SubTotal, 2, ",", ".");}}</td>
            </tr>
<tr>
                <td colspan="2"></td>
                <td style="text-align: right; font-weight: bold;">Diskon</td>
                <td style="text-align: right; font-weight: bold;">{{ "Rp. " . number_format($data->Diskon, 2, ",", ".");}}</td>
            </tr>
            <tr>
                <td colspan="2"></td>
             ...
             <tr>
                ...
                <td style="text-align: right; font-weight: bold;">{{ "Rp. " . number_format($data->Total, 2, ",", ".");}}</td>
            </tr>
        </tbody>
    </table>
