...
<div class="page-wraper">
    ...
    <div class="browse-job login-style3">
        <!-- Coming Soon -->
        <div class="bg-img-fix overflow-hidden" style="background-image:url({{asset('')}}assets/images/background/bg6.jpg); height: 100vh;">
            <div class="row gx-0">
							...
							<div class="login-form style-2">
								...
								<div class="card-body">
									<div class="logo-header">
										<a href="index.html" class="logo"><img src="{{asset('')}}assets/images/logo.png" alt="" class="mCS_img_loaded"></a>
									  ...
									  <div class="tab-pane fade show active" id="nav-personal" role="tabpanel" aria-labelledby="nav-personal-tab">
										<form class=" dez-form pb-3" method="POST" action="{{ route('login') }}">
                                                ...
                                                <div class="text-center bottom">
                                                    <button class="btn btn-primary button-md btn-block" id="nav-sign-tab" type="submit">Login</button>
									...
									<div class="card-footer">
										...
										<div class="col-lg-12 text-center">
											...
											<a href="javascript:void(0);">Digital Indonesia Hebat </a> All rights reserved.</span>
										</div>
									</div>
								</div>
