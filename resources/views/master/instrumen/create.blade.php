    ...
    <div class="row">
        ...
        <div class="mb-3 col-md-6">
            ...
            <div class="input-group">
                ...
                <input type="text" name="Tarif" class="form-control @error('Tarif') is-invalid @enderror" placeholder="Tarif" onkeyup="this.value=formatRupiah(this.value)" value="{{ old('Tarif') }}">
        ...
        <div class="mb-3 col-md-6">
            ...
            <select name="Akreditasi" class="form-control @error('Akreditasi') is-invalid @enderror">
                ...
                <option value="TIDAK" {{ old('Akreditasi') == 'TIDAK' ? 'selected' : '' }}>TIDAK</option>
            </select>
            @error('Akreditasi')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
        ...
        <div class="mb-3 col-md-6">
            ...
            <select class="multi-select select2-hidden-accessible @error('AlatUkur') is-invalid @enderror" name="AlatUkur[]" multiple tabindex="-1" aria-hidden="true">
                @foreach ($data as $x)
                    <option value="{{ $x->id }}" {{ collect(old('AlatUkur'))->contains($x->id) ? 'selected' : '' }}>
                        {{ $x->Nama }}
                    </option>
                @endforeach
            </select>
        ...
        <div class="mb-3 col-md-6">
            ...
            <select name="Status" id="" class="form-control @error('Status') is-invalid @enderror">
                ...
                <option value="TIDAKAKTIF" {{ old('Status') == 'TIDAKAKTIF' ? 'selected' : '' }}>Tidak Baik</option>
            </select>
            @error('Status')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
