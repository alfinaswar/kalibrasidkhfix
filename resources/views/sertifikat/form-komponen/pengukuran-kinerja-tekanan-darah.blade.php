    ...
    <thead class="thead-dark bg-primary text-white">
        <tr>
            ...
            <th colspan="2" style="vertical-align: middle; text-align: center;">Titik&nbsp;&nbsp;&nbsp;Ukur</th>
    ...
    <tbody>
        @for ($section = 0; $section < 4; $section++)
            @for ($row = 0; $row < 3; $row++)
                <tr>
                    @if ($row == 0)
                        <td colspan="3" rowspan="3" style="vertical-align: middle; font-weight: bold; text-align: center;" width="10%">Tekanan (mmHg)</td>
                        <td rowspan="3">{{ $section + 1 }}</td>
                        <td><input type="text" class="form-control" name="Titik_Ukur_Nama[]" placeholder="Systol / MAP / Diastole"></td>
                        <td><input type="text" class="form-control" name="Titik_Ukur_Hasil[]" placeholder="Hasil"></td>
                        <td><input type="text" class="form-control" name="Pengulangan1_Tekanan_Darah[]" placeholder="Hasil"></td>
                        <td><input type="text" class="form-control" name="Pengulangan2_Tekanan_Darah[]" placeholder="Hasil"></td>
                        <td><input type="text" class="form-control" name="Pengulangan3_Tekanan_Darah[]" placeholder="Hasil"></td>
