                            ...
                            <h3 class="card-title text-center text-black fw-bold" style="text-decoration: underline;">
                               ...
                               <span class="text-primary fw-bold text-uppercase">SATURASI OKSIGEN</span>
                               </center>
...
<tbody>
  <tr>
    ...
    <td><input type="text" class="form-control" name="Titik_Ukur_saturasi_oksigen[]" placeholder="Titik Ukur"></td>
    <td><input type="text" class="form-control" name="Pengulangan1_saturasi_oksigen[]" placeholder="Hasil"></td>
    <td><input type="text" class="form-control" name="Pengulangan2_saturasi_oksigen[]" placeholder="Hasil"></td>
    <td><input type="text" class="form-control" name="Pengulangan3_saturasi_oksigen[]" placeholder="Hasil"></td>
