                            ...
                            <h3 class="card-title text-center text-black fw-bold" style="text-decoration: underline;">
                               ...
                               <span class="text-primary fw-bold text-uppercase">HEART RATE</span>
                               </center>
...
<tbody>
  <tr>
    ...
    <td><input type="text" class="form-control" name="Titik_Ukur_Heartrate[]" placeholder="Titik Ukur"></td>
    <td><input type="text" class="form-control" name="Pengulangan1_Heartrate[]" placeholder="Hasil"></td>
    <td><input type="text" class="form-control" name="Pengulangan2_Heartrate[]" placeholder="Hasil"></td>
    <td><input type="text" class="form-control" name="Pengulangan3_Heartrate[]" placeholder="Hasil"></td>
