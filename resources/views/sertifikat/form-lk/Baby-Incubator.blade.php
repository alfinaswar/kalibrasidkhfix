            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('job.store') }}">
                        ...
                        @include('sertifikat.form-komponen.babyincubator.pengukuran-kondisi-lingkungan')

                        {{-- Komponen Pemeriksaan Fisik dan Fungsi Alat --}}
                        @include('sertifikat.form-komponen.babyincubator.pemeriksaan-fisik-dan-fungsi-alat')

                        {{-- Komponen Pengukuran Keselamatan Listrik --}}
                        @include('sertifikat.form-komponen.pengukuran-keselamatan-listrik')

                        {{-- Pengujian --}}
                        @include('sertifikat.form-komponen.babyincubator.pengujian-kinerja')
